/**
 * Script para insertar "Producto Dos" en Firebase
 *
 * INSTRUCCIONES:
...
(async function insertProductoDos() {
  console.log('🚀 Iniciando inserción de Producto Dos...');

  // Obtener la instancia de Firestore desde el módulo local
  const firebaseModule = await import('/src/js/firebase.js');

  // Esperar a que Firebase se inicialice
  await firebaseModule.initializeFirebase();

  const db = firebaseModule.db;

  // Importar funciones de Firestore desde el mismo paquete que usa la app
